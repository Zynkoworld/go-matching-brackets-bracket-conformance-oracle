# zynko-oracle · `go-matching-brackets-bracket-conformance-oracle`

**A deterministic, re-checkable conformance oracle for `matching-brackets` (go).**
...
## Provenance
Reference: the Exercism reference solution for `matching-brackets` (go; MIT, Exercism), body unchanged. Proven by the exercism testsuite (pin=0a4094d08cd75205), re-executed by harvest in a sealed sandbox (unshare -rn) before this bundle was generated.
